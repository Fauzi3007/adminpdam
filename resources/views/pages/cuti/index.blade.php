<x-app-layout>
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <!-- Cards -->
        <a href="{{ route('cuti.create') }}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
        ...
        <div class="grid grid-cols-12 gap-6 mt-2">
                ...
                <div
                    ...
                    <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                        <h2 class="font-semibold text-slate-800 dark:text-slate-100">Cuti</h2>
                    </header>
                    <div class="p-3">
                                ...
                                <tbody class="text-sm divide-y divide-slate-100 dark:divide-slate-700">
                                    <tr>
                                        @forelse ($cutis as $item)
                                            ...
                                            <td class="p-2 whitespace-nowrap">
                                                @if ($item->bukti_foto)
                                                    <button class="px-4 py-2 rounded-md bg-blue-500 hover:bg-blue-600 text-white sm:mt-0"
                                                        onclick="showImage('{{ asset('storage/images/' . $item->bukti_foto) }}')">Show Image</button>
                                                @endif
                                            </td>
                                            <!-- Modal -->
                                            ...
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="text-left">{{ $item->tanggal_mulai }}</div>
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="text-left">{{ $item->tanggal_selesai }}</div>
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
