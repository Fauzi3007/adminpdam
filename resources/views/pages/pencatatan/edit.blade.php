      ...
      <form action="{{route('pencatatan.update',$pencatatan->id_pencatatan)}}" method="post" class="grid grid-cols-2 gap-6 mt-2" enctype="multipart/form-data">
        ...
        @csrf
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <x-input id="nomor_pelanggan" type="text" name="nomor_pelanggan" :value="old('nomor_pelanggan',$pencatatan->nomor_pelanggan)" required />
              ...
              <x-input id="foto_meteran" type="text" name="foto_meteran" :value="old('foto_meteran',$pencatatan->foto_meteran)"  />
