        ...
        <div class="grid grid-cols-12 gap-6 mt-2">
                <div
                    ...
                    <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                        <h2 class="font-semibold text-slate-800 dark:text-slate-100">Cabang</h2>
                    </header>
                    <div class="p-3">
                            ...
                            <table class="table-auto w-full">
                                ...
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th class="p-2 whitespace-nowrap">
                                            <div class="font-semibold text-left">Nama Cabang</div>
                                        </th>
                                        <th class="p-2 whitespace-nowrap">
                                            <div class="font-semibold text-left">Latitude Cabang</div>
                                        </th>
                                        <th class="p-2 whitespace-nowrap">
                                            <div class="font-semibold text-left">Longitude Cabang</div>
                                        </th>
                                ...
                                <tbody class="text-sm divide-y divide-slate-100 dark:divide-slate-700">
                                    <tr>
                                        @forelse ($cabangs as $item)
                                            ...
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="text-left">{{ $item->nama_cabang }}</div>
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="text-left">{{ $item->latitude_cabang }}</div>
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="text-left">{{ $item->longitude_cabang }}</div>
                                            </td>
                                            ...
                                            <td class="p-2 whitespace-nowrap flex justify-center items-center gap-1">
                                                ...
                                                <form action="{{ route('cabang.destroy', $item->id_cabang) }}"
