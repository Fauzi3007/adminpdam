<x-app-layout>
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <!-- Cards -->
        <a href="{{ route('absensi.create') }}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
            <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                <path
                    d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
            </svg>
            <span class="hidden xs:block ml-2">Tambah Absensi</span>
        </a>
                            ...
                            <table class="table-auto w-full">
                                ...
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th class="p-2 whitespace-nowrap">
                                            <div class="font-semibold text-left">Waktu Masuk</div>
                                        </th>
                                        <th class="p-2 whitespace-nowrap">
                                            <div class="font-semibold text-left">Waktu Keluar</div>
                                        </th>
                                        <th class="p-2 whitespace-nowrap">
                                ...
                                <tbody class="text-sm divide-y divide-slate-100 dark:divide-slate-700">
                                    <tr>
                                        @forelse ($absensis as $item)
                                            ...
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="text-left">{{ $item->waktu_masuk }}</div>
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="text-left">{{ $item->waktu_keluar }}</div>
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
                                            ...
                                            <td class="p-2 whitespace-nowrap flex justify-center items-center gap-1">
                                                <a href="{{ route('absensi.edit', $item->id_absensi) }}"
                                                    class="px-4 py-2 rounded-md bg-yellow-300 hover:bg-yellow-400 text-white sm:mt-0">Edit</a>
                                                <form action="{{ route('absensi.destroy', $item->id_absensi) }}"
